...
export const ui = {
    en: {
        ...
        // Home page (Staging - Full Portfolio)
        'home.strategicProjects': 'Strategic Projects',
        'home.projectsSubtitle': 'Selected work from 10+ years in product management',
        'home.coreExpertise': 'Core Expertise',
        'home.ctaTitle': "Let's Build Something Great",
        'home.ctaDescription': 'Interested in product leadership, digital transformation, or just want to chat about the intersection of technology and human behavior?',
    ...
    'pt-br': {
        ...
        // Home page (Staging - Full Portfolio)
        'home.strategicProjects': 'Projetos Estratégicos',
        'home.projectsSubtitle': 'Trabalhos selecionados de mais de 10 anos em gestão de produtos',
        'home.coreExpertise': 'Principais Competências',
        'home.ctaTitle': 'Vamos Construir Algo Incrível',
        'home.ctaDescription': 'Interessado em liderança de produto, transformação digital, ou quer conversar sobre a interseção entre tecnologia e comportamento humano?',
